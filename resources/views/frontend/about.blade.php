		...
		<div class="welcome-section-1 container-fluid no-padding">
			...
			<div class="container">
				...
				<div class="col-md-7 col-sm-7 col-xs-6 wc-img-box">
					<img src="frontend/images/welcome-1.png" alt="welcome" width="754" height="502" />
				</div>

				<div class="col-md-5 col-sm-5 col-xs-6">
					<div class="mission-content">
						<img src="frontend/images/welcome-ic-1.png" alt="welcome-ic" width="71" height="71">
						<h3>Our Mission</h3>
						<p>The day for a three hour tour a three hour tour then one day he was shooting.</p>
					</div>

					<div class="mission-content">
						<img src="frontend/images/welcome-ic-2.png" alt="welcome-ic" width="71" height="71">
						<h3>Our vision</h3>
						<p>The day for a three hour tour a three hour tour then one day he was shooting.</p>
					</div>

					<div class="mission-content">
						<img src="frontend/images/welcome-ic-3.png" alt="welcome-ic" width="71" height="71">
						<h3>What We do</h3>
						<p>The day for a three hour tour a three hour tour then one day he was shooting.</p>
					</div>
				</div>
					...
					<div role="listbox" class="carousel-inner">
						<div class="item active">
							<div class="testimonial-content">
								...
								<img src="frontend/images/testimonial.jpg" alt="testimonial" height="89" width="89" />
