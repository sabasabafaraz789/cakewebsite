    ...
    <div class="container-fluid"><br>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="{{ url('/admin/admins-list') }}" class="btn btn-info">Admins</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                ...
                                <input class="form-control" id="inputContact" type="tel" placeholder="+923451234567"
                                    name="contact" value="{{ old('contact', $admin->contact ?? '') }}">
                                <span class="text-danger">
                                    @error('contact')
                                        {{ $message }}
                                    @enderror
